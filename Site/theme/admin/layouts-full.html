<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Full Layout | Hyper - Responsive Bootstrap 5 Admin Dashboard</title>
    ...
    <body class="loading hide-menu" data-layout="full" data-layout-color="light" data-leftbar-theme="dark" data-layout-mode="fluid" data-rightbar-onstart="true">
        <!-- Begin page -->
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
