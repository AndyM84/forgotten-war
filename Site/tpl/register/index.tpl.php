...
<?php $this->layout('shared::auth-master', ['page' => $page]); ?>
		...
		<form class="form-register" method="post" action="<?=$page->getAssetPath('~/register.php')?>">
...
<?php endif; ?>
			...
			<input type="email" id="inputEmail" name="email" class="form-control top" placeholder="Email address" required autofocus />

			<label for="inputConfirmEmail" class="sr-only mb-3">Email address</label>
			<input type="email" id="inputConfirmEmail" name="confirmEmail" class="form-control bottom mb-3" placeholder="Confirm email address" required />
			...
			<div class="checkbox">
				<label>
					<input type="checkbox" name="tosAgreed" required /> I agree to the Terms of Service
				</label>
			</div>

			<div class="checkbox mb-3">
				<label>
					<input type="checkbox" name="ppAgreed" required /> I agree to the Privacy Policy
				</label>
			</div>
